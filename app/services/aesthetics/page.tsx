        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-24 pb-20">
          ...
          <div className="flex items-center gap-5 parallax-medium" style={{ animation: 'fadeInUp 0.8s ease-out both', transform: `translateY(${scrollY * 0.18}px)` }}>
            ...
            <div>
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-white">Aesthetic Services</h1>
              <p className="text-white/50 mt-2 text-lg">Enhance Your Natural Beauty</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
            {[
              ...
              <div key={i} className="relative h-56 rounded-2xl overflow-hidden border border-white/[0.08] group parallax-slow" style={{ transform: `translateY(${img.offset}px)` }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="card-dark p-8">
                <h2 className="text-2xl font-bold text-white mb-4">About Our Aesthetic Services</h2>
                <p className="text-white/50 leading-relaxed mb-3">At The Venous Lounge, we offer a comprehensive range of aesthetic and cosmetic procedures designed to help you look and feel your best. Our treatments are performed by Dr Sesing in a comfortable, lounge-style environment.</p>
                <p className="text-white/50 leading-relaxed">We combine medical expertise with aesthetic artistry to deliver natural-looking results that enhance your confidence and well-being.</p>
              </div>

              <div className="card-dark p-8">
                <h2 className="text-2xl font-bold text-white mb-5">Our Aesthetic Treatments</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="card-dark-2 p-5 hover:border-violet-500/20 transition-all duration-300">
              ...
              <div className="card-dark p-8">
                <h2 className="text-2xl font-bold text-white mb-5">Popular Procedures</h2>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="card-dark-2 p-5 rounded-xl">
                      <div className="text-white font-semibold text-sm mb-3">{p.name}</div>
                      <div className="grid grid-cols-3 gap-3 text-xs">
                        {[['Areas', p.areas], ['Duration', p.duration], ['Results', p.results]].map(([label, val], j) => (
                          <div key={j}>
                            ...
                            <div className="text-white/60">{val}</div>
                          </div>
                        ))}
                      </div>
                    </div>
              ...
              <div className="card-dark p-8">
                <h2 className="text-2xl font-bold text-white mb-5">Your Treatment Journey</h2>
                <div className="space-y-5">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-4">
                      <div className="w-10 h-10 rounded-xl bg-violet-600/20 border border-violet-500/30 flex items-center justify-center text-lg flex-shrink-0">{item.icon}</div>
                      <div>
            ...
            <div className="space-y-5">
              <div className="card-dark p-7">
                <h3 className="text-white font-bold text-lg mb-3">Book Your Consultation</h3>
                <p className="text-white/40 text-sm mb-5">Discover how aesthetic treatments can enhance your natural beauty.</p>
              ...
              <div className="card-dark p-7">
                <h3 className="text-white font-bold text-lg mb-4">Treatment Benefits</h3>
                <div className="space-y-4">
                  {[
              ...
              <div className="card-dark p-6 border-violet-500/20">
                <div className="flex items-start gap-3">
                  <span className="text-2xl">💡</span>
                  <div>
                    <div className="text-white font-semibold text-sm mb-1">First Time?</div>
                    <p className="text-white/40 text-xs leading-relaxed">Book a complimentary consultation to discuss your aesthetic goals and learn about the best treatments for you.</p>
                  </div>
                </div>
              </div>
            </div>
