        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-24 pb-20">
          ...
          <FadeIn delay={0.1}>
            <div className="flex items-center gap-5">
              <div className="w-16 h-16 rounded-xl bg-gold/10 border border-gold-bright/20 flex items-center justify-center flex-shrink-0">
                <span className="text-4xl">🦵</span>
              </div>
              <div>
                <div className="section-label mb-3">Vein Treatment</div>
                <h1 className="text-4xl lg:text-6xl font-bold text-ivory">Varicose Veins Treatment</h1>
                <p className="text-silver mt-2 text-lg">Advanced Minimally Invasive Solutions</p>
              </div>
            </div>
          </FadeIn>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="relative h-56 rounded-2xl overflow-hidden border border-graphite group">
            ...
            <div className="lg:col-span-2 space-y-6">
              <FadeIn>
                <div className="card-dark p-8">
                  <h2 className="text-2xl font-bold text-ivory mb-4">About Varicose Veins</h2>
                  <p className="text-silver leading-relaxed mb-3">Varicose veins are enlarged, twisted veins that commonly appear in the legs. At The Venous Lounge, we specialise in modern, minimally invasive treatments that allow you to walk in and walk out the same day.</p>
                  <p className="text-silver leading-relaxed">Our procedures are performed by Dr Sesing, an experienced vein specialist, using the latest techniques to ensure minimal discomfort and maximum results.</p>
                </div>
              </FadeIn>
                ...
                <div className="card-dark p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {['Endovenous Laser Ablation (EVLA)', 'Radiofrequency Ablation', 'Sclerotherapy', 'Ambulatory Phlebectomy', 'Ultrasound-Guided Treatment', 'Compression Therapy', 'Medical Consultations', 'Follow-up Care'].map((s, i) => (
                      <div key={i} className="flex items-center gap-3 text-silver text-sm">
              ...
              <FadeIn delay={0.2}>
                <div className="card-dark p-8">
                  <h2 className="text-2xl font-bold text-ivory mb-5">Symptoms We Treat</h2>
                  <div className="grid grid-cols-2 gap-3">
                    {['Visible twisted veins', 'Leg pain and aching', 'Swelling in legs', 'Heavy feeling in legs', 'Skin discoloration', 'Itching around veins', 'Leg cramps', 'Restless legs'].map((s, i) => (
                      <div key={i} className="card-dark-2 px-4 py-2.5 text-silver text-sm rounded-xl">{s}</div>
                    ))}
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.3}>
                <div className="card-dark p-8">
                  <h2 className="text-2xl font-bold text-ivory mb-5">Why Choose Us?</h2>
                  <ul className="space-y-3">
                    {['Walk-in, walk-out procedures — no hospital stay required', 'All major medical aids accepted', 'Experienced vein specialist — Dr Sesing', 'Latest minimally invasive techniques', 'Flexible appointment times (Mon–Fri: 08:00–22:00, Sat: 08:00–13:00)', 'Comfortable lounge-style environment', 'Comprehensive follow-up care'].map((b, i) => (
                      <li key={i} className="flex items-start gap-3 text-silver text-sm">
                        <CheckCircle2 className="w-4 h-4 text-confirmed flex-shrink-0 mt-0.5" />
                        {b}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="space-y-5">
              <FadeIn direction="right">
                <div className="card-dark p-7">
                  <h3 className="text-ivory font-bold text-lg mb-3">Book a Consultation</h3>
                  <p className="text-silver text-sm mb-5">Schedule your varicose vein assessment today.</p>
              ...
              <FadeIn direction="right" delay={0.2}>
                <div className="card-dark p-7">
                  <h3 className="text-ivory font-bold text-lg mb-4">Operating Hours</h3>
                  <div className="space-y-2 text-sm">
                    {[['Monday – Friday', '08:00 – 22:00'], ['Saturday', '08:00 – 13:00'], ['Sunday', 'Closed']].map(([day, hrs], i) => (
                      <div key={i} className="flex justify-between">
                        ...
                        <span className="text-mist">{hrs}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <FadeIn direction="right" delay={0.3}>
                <div className="card-dark p-7">
                  <h3 className="text-ivory font-bold text-lg mb-3">Medical Aid</h3>
                  <p className="text-silver text-sm mb-3">We accept all major medical aid schemes.</p>
