  ...
  return (
    <div className="bg-white text-ivory overflow-hidden">
      ...
      <section className="relative py-32 overflow-hidden border-t border-graphite">
        <div className="grid-lines">{[...Array(7)].map((_, i) => <div key={i} className="grid-line-v" />)}</div>
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-gold/8 rounded-full filter blur-[120px] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-16">
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <motion.div
                  className="card-dark p-10 hover:border-gold-bright/25 transition-all duration-300 group"
                  whileHover={{ y: -4 }}
                >
                  <div className="w-12 h-12 rounded-xl bg-gold/10 border border-gold-bright/20 flex items-center justify-center mb-6 group-hover:bg-gold/20 transition-colors">
                    <item.Icon className="w-6 h-6 text-gold" />
                  </div>
                  <h3 className="text-ivory text-2xl font-bold mb-4">{item.title}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  ...
                  <FadeIn key={i} delay={i * 0.08}>
                    <motion.div className="card-dark-2 p-6 text-center hover:border-gold-bright/20 transition-all duration-300 group"
                      whileHover={{ y: -2 }}
                    >
                      <div className="w-12 h-12 rounded-lg bg-gold/10 border border-gold-bright/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div style={{ animation: 'fadeInUp 0.8s ease-out both' }}>
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-ivory mb-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <FadeIn key={i} delay={i * 0.08}>
                  <motion.div className="card-dark p-5 flex items-start gap-4 hover:border-gold-bright/20 transition-all duration-300 group"
                    whileHover={{ x: 4 }}
                  >
                    ...
                    <div>
                      <div className="text-ivory font-semibold">{f.title}</div>
                      <div className="text-silver text-sm mt-0.5">{f.desc}</div>
                    </div>
                  </motion.div>
                </FadeIn>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <FadeIn key={i} delay={i * 0.08}>
                <motion.div
                  className="card-dark p-7 text-center hover:border-gold-bright/25 transition-all duration-300 group"
                  whileHover={{ y: -4 }}
                >
                  <div className="w-12 h-12 rounded-lg bg-gold/10 border border-gold-bright/20 flex items-center justify-center mx-auto mb-5 group-hover:bg-gold/20 transition-colors">
                    <v.Icon className="w-5 h-5 text-gold" />
                  </div>
                  <h3 className="text-ivory font-semibold mb-2">{v.title}</h3>
                  <p className="text-silver text-sm">{v.desc}</p>
                </motion.div>
              </FadeIn>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            {[
              ...
              <FadeIn key={i} delay={i * 0.15}>
                <motion.div
                  className="group card-dark overflow-hidden hover:border-gold-bright/25 transition-all duration-300"
                  whileHover={{ y: -4 }}
                >
                  <Link href="/booking" className="block">
                    ...
                    <div className="p-8">
                      <h3 className="text-ivory text-xl font-bold mb-1">{member.name}</h3>
                      <p className="text-gold text-sm font-medium mb-4">{member.role}</p>
                      <p className="text-silver text-sm leading-relaxed mb-5">{member.desc}</p>
                      <div className="flex flex-wrap gap-2">
                        {member.specs.map((s, j) => (
                          <span key={j} className="text-xs px-3 py-1 rounded-full border border-graphite text-silver">{s}</span>
                        ))}
                      </div>
                      <div className="mt-6 text-gold text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-2">
                        Book Consultation
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <FadeIn key={i} delay={i * 0.08}>
                <motion.div className="card-dark p-6 text-center hover:border-gold-bright/20 transition-all duration-300 group"
                  whileHover={{ y: -2 }}
                >
                  <div className="w-12 h-12 rounded-lg bg-gold/10 border border-gold-bright/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
                    <item.Icon className="w-5 h-5 text-gold" />
      ...
      <section className="relative py-32 overflow-hidden border-t border-graphite">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[600px] h-[300px] bg-gold/10 rounded-full filter blur-[100px]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <FadeIn key={i} delay={i * 0.08}>
                <motion.div
                  className="card-dark p-8 text-center hover:border-gold-bright/25 transition-all duration-300 group"
                  whileHover={{ y: -4 }}
                >
                  <div className="w-12 h-12 rounded-lg bg-gold/10 border border-gold-bright/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
                    <s.Icon className="w-5 h-5 text-gold" />
                  </div>
                  <div className="text-4xl font-bold text-ivory mb-2">{s.number}</div>
                  <div className="text-silver text-sm">{s.label}</div>
                </motion.div>
              </FadeIn>
            ))}
          </div>
